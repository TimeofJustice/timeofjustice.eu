...
class Image(models.Model):
    image = models.ImageField(upload_to=os.path.join(settings.BASE_DIR, 'data/images/'))
    preview = models.ImageField(upload_to=os.path.join(settings.BASE_DIR, 'data/images/'))
